                ...
                <div key={a._id} className="p-5 bg-white dark:bg-slate-800/40 rounded-2xl border border-slate-100 dark:border-slate-800 relative overflow-hidden group">
                  ...
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="flex flex-col items-end gap-2">
                      ...
                      {/* Cancel Button - Relocated to avoid overlap */}
                      {(a.status === STATUS.PENDING || a.status === STATUS.APPROVED || a.status === STATUS.ASSIGNED) && (
                        <button 
                          onClick={() => handleCancelClick(a._id)}
                          className="text-[9px] font-bold uppercase tracking-wider text-rose-500 hover:text-white hover:bg-rose-500 px-2 py-1 rounded-lg transition-all duration-300 border border-rose-200 dark:border-rose-900/50 hover:border-rose-500 shadow-sm"
                        >
                          Cancel
                        </button>
                      )}
